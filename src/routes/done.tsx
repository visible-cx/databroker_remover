...
export default function Home() {
  ...
  if (location.state && location.state.email) {
    ...
    joinLink = `https://i.prefinery.com/projects/rjddzqda/users/instant?email=${email}&utm_source=utm_source&utm_campaign=utm_campaign`
  } else {
    joinLink = `https://www.visible.cx/lp/join`
  }
    ...
    <>
      <main class="mt-10">
        <div class="container mx-auto px-4 text-center mb-10">
          ...
          <div class="bg-blue-400 my-4 max-w-fit justify-center flex rounded-md mx-auto px-4 py-1 text-white font-semibold">
            <a href={joinLink} class="fit-content rounded-md p-2 m-auto">
              Join the community
            </a>
          </div>
        </div>
        <div class="section bg-sky-50">
          <div class="container mx-auto px-4 text-left p-5">
            <h1 class="text-3xl mb-20 mt-10 font-semibold ">
              See how you appear online, control your digital body language.
            </h1>
            <div class="grid md:grid-cols-3 gap-4">
              <div class="col-span-2">
                ...
                <div class="bg-blue-400 my-4 max-w-fit justify-center flex rounded-md px-4 py-1 text-white font-semibold">
                  <a href={joinLink} class="fit-content rounded-md p-2 m-auto">
                    Join the community
                  </a>
                </div>
